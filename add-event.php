        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form role="form" method="POST" action="proses_add_event.php" enctype="multipart/form-data">

                <div class="form-group row">
                  <div class="col-sm-2 col-form-label"><label for="exampleInputJudul">Judul</label></div>
                  <div class="col-sm-10"> <input required type="text" class="form-control" id="Judul"
                      placeholder="Masukan Judul Event" name="judul"></div>
                </div>

                <div class="form-group row">
                  <div class="col-sm-2 col-form-label"><label for="exampleInputIsi">Isi</label></div>
                  <div class="col-sm-10"> <textarea required class="form-control" id="isi"
                      placeholder="Masukan Isi Event" name="isi"></textarea></div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10"> <input required type="text" class="form-control" id="Lokasi"
                      placeholder="Masukan Lokasi Event" name="lokasi"></div>
                </div>

                <div class="form-group row">
                  <div class="col-sm-2 col-form-label"><label for="exampleInputHarga">Harga</label></div>
                  <div class="col-sm-10"> <input required type="text" class="form-control" id="Harga"
                      placeholder="Masukan Harga Event" name="harga"></div>
                </div>
