...
if(isset($_POST["login"])){
  ...
  $result = mysqli_query($con,"SELECT * FROM admin1 WHERE username = '$username'");
    ...
    <div class="main">
      <div class="container a-container" id="a-container">
        <form class="form" id="a-form" method="post" action="">
          <h2 class="form_title title">Create Account ADMIN</h2>
          ...
          <a style="margin-top: 20px; text-decoration:underline;" href="register.php">Sign Up User</a>
        </form>
      </div>
