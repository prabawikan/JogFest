...
<div class="content-wrapper">
  ...
  <!-- /.content-header -->
  <div class="col-lg-3 col-xs-6"><a href="./add-event.php" class="small-box-footer">
      <div class="small-box bg-dark">
        <div class="inner">
          <H5>Tambah Event <i class="fa fa-arrow-circle-right"></i></H5>
          <div class="icon">
            ...
            <div class="card-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <?php
                  $nomor = 1;
                  $results = mysqli_query($conn, "SELECT e.*, k.nama_kategori
                  FROM event e
                  ...
                  while ($rows = mysqli_fetch_array($results, MYSQLI_ASSOC)) {
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="edit_event.php?id=<?php echo $rows['id_event']; ?>" style="color: white;">
                          <button class="btn btn-dark btn-sm">Edit</button>
                        </a>

                        <a style="color: white;" href="proses_hapus_event.php?id=<?php echo $rows['id_event']; ?>">
